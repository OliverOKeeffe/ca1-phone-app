...
@endif --}}
<!-- Creating the text boxes to add data to to create retailers -->
<form action="{{ route('admin.retailers.store') }}" method="post">    
    ...
    <div>
        ...
        <span>{{ $errors->first('locations') }}</span>
        @endif
    </div>
    ...
    <button type="submit" class="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800"><a href="{{ route('admin.retailers.index') }}">Back</a></button>
</form>
@endsection
