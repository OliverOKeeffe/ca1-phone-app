...
@section('content')
<h3><strong>Create Retailer</strong></h3>    
...
<form action="{{ route('retailers.store') }}" method="post">
    @csrf
    <!-- creating the text boxes to add data to for the retailers table -->
    <div>
    ...
    <div>
        ...
        <input type="text" name="num_locations" id="num_locations" value="{{  old('num_location') }}"/>
...
<!-- <div class="grid gap-6 mb-6 md:grid-cols-2">
        ...
        <div>
            <label for="num_locations" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Number of Locations</label>
            <input type="text" id="num_locations" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
        </div>  -->