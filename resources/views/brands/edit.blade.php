...
@endif --}}
<!-- creating the text boxes to update and edit the data -->
<form action="{{ route('brands.update', $brand->id ) }}" method="post">
    ...
    <!-- using tailwind css to make the creat button look better -->
    ...
    <!-- created a back button and then styled it using tailwind and css -->
